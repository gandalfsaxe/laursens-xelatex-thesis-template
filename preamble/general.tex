...
% Scientific
\usepackage{siunitx}   % Consistent numbers and units, ranges, decimals etc. e.g. \SI{20}{\kilometer} or \SIrange{60}{300}{\second}. See list of units at http://mirrors.dotsrc.org/ctan/macros/latex/contrib/siunitx/siunitx.pdf
